namespace quanlykhachsan
{
    partial class frmnhanvien
    {
        ...
        public void xoa_NV1(int maNhanVien)
        {
        ...
        public void sua_nhanvien1(string hoTen, bool gioiTinh, DateTime ngaySinh, string soChungMinh, string diaChi, string soDienThoai, DateTime ngayVaoLam, int maNhanVien)
        {
            SqlConnection cnn = ketnoi.Get();
            SqlCommand cmd = new SqlCommand("sua_nhanvien", cnn);
            cmd.CommandType = CommandType.StoredProcedure;
